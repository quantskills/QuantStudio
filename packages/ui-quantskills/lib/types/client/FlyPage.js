...
function FlyPlans({ access }) {
    ...
    return _jsxs("div", { id: "fly-contest-plans", className: "fv-contest-plans", children: [_jsx("h2", { children: "\u679C\u8747\u4EA4\u6613\u8BA1\u5212" }), _jsx("p", { children: "\u6838\u5BF9\u8D26\u6237\u3001\u5408\u7EA6\u4E0E\u624B\u6570\u540E\u9010\u7B14\u786E\u8BA4\u3002\u505C\u6B62\u5EFA\u8BAE\u4E0D\u4F1A\u64A4\u9500\u5DF2\u63D0\u4EA4\u7684\u59D4\u6258\uFF1B\u5F85\u786E\u8BA4\u8BA1\u5212\u53EF\u5728\u6B64\u53D6\u6D88\u3002" }), _jsx(ContestPlans, { status: filtered, access: access, refresh: state.refresh })] });
}
