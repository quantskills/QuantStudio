...
function SessionContestReview({ sessionId, binding, running, access, openContest }) {
    ...
    return _jsxs("section", { className: css.conversation, "aria-label": "\u6BD4\u8D5B\u4E13\u7528\u5BF9\u8BDD", children: [_jsxs("div", { className: css.conversationHeader, children: [_jsxs("strong", { children: ["\u4EFF\u771F\u6BD4\u8D5B \u00B7 ", binding.contestConversation === 'topic' ? '专题研究' : binding.contestConversation === 'main' ? '账户主对话' : '比赛研究'] }), _jsxs("small", { children: ["\u300C\u5DC5\u5CF0\u4EA4\u6613\u8005\u300D\u5168\u56FD\u671F\u8D27\u6A21\u62DF\u8D5B \u00B7 \u8D26\u6237 ", identity.accountId, " \u00B7 ", identity.contestId] }), _jsx("button", { type: "button", onClick: openContest, children: "\u6BD4\u8D5B\u5DE5\u4F5C\u53F0" }), ready && status && _jsx(ContestPlans, { status: status, access: access, refresh: refresh, compact: true, autoOpen: !running })] }), !status ? _jsx("p", { role: "status", children: "\u8BFB\u53D6\u6BD4\u8D5B\u72B6\u6001\u2026" }) : !ready ? _jsx("p", { role: "status", children: !status.enabled ? '比赛模式已关闭，普通会话照常使用。已提交委托仍由柜台处理。'
