...
import { FlyContestPanel } from "./FlyContestPanel.js";
...
export function ContestPage({ access, flyAccess, openFly, researchSessions = [], openResearch, openModelSettings }) {
    if (!access)
        return _jsxs("section", { className: css.page, children: [_jsx("h1", { children: "\u300C\u5DC5\u5CF0\u4EA4\u6613\u8005\u300D\u5168\u56FD\u671F\u8D27\u6A21\u62DF\u8D5B" }), _jsx("p", { children: "\u6BD4\u8D5B\u529F\u80FD\u6682\u672A\u5C31\u7EEA\uFF0C\u8BF7\u91CD\u65B0\u542F\u52A8\u5E94\u7528\u3002" })] });
    return _jsx(ConnectedContestPage, { access: access, flyAccess: flyAccess, openFly: openFly, researchSessions: researchSessions, openResearch: openResearch, openModelSettings: openModelSettings });
}
function ConnectedContestPage({ access, flyAccess, openFly, researchSessions = [], openResearch, openModelSettings }) {
