...
export declare const MINIMAL_THEMES: readonly [{
...
export declare const findMinimalTheme: (background: string) => {
    readonly id: "minimal-blue";
    readonly background: "motion-minimal-blue";
    readonly label: "极简 · 雾蓝";
    readonly description: "冷蓝流光，清晰有序";
...
export declare function minimalThemeStyle(theme: typeof MINIMAL_THEMES[number]): Record<string, string>;
export declare function minimalBackgroundImage(theme: typeof MINIMAL_THEMES[number]): string;
//# sourceMappingURL=minimal-themes.d.ts.map