...
import { DEFAULT_ARTIFACT_THEME, useArtifactTheme } from "./artifact-theme.js";
import { artifactThemeRuntime } from "./artifact-theme-runtime.js";
...
export function isolatedHtmlDocument(source, title, theme = DEFAULT_ARTIFACT_THEME) {
...
export function InteractiveHtml({ source, title, className }) {
    ...
    return _jsx("iframe", { ref: frame, onLoad: sync, className: className, title: title, sandbox: "allow-scripts", referrerPolicy: "no-referrer", allow: "camera 'none'; microphone 'none'; geolocation 'none'; clipboard-read 'none'; clipboard-write 'none'", srcDoc: document });
}
//# sourceMappingURL=InteractiveHtml.js.map