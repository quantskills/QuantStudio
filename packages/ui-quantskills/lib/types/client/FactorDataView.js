...
export function FactorDataView({ value, depth = 0 }) {
    if (value == null)
        return _jsx("p", { className: css.muted, children: "\u6682\u65E0\u6570\u636E\u3002" });
    if (typeof value !== 'object')
        return _jsx("span", { children: display(value) });
    if (depth >= 3)
        return _jsx("pre", { className: styles.json, children: JSON.stringify(value, null, 2) });
