import type {
  ...
  QuantSkillsAgentDefinition, QuantSkillsAgentSessionArchiveItem,
  QuantSkillsLibrarySourceRecord,
  QuantSkillsAgentTeamDefinition, QuantSkillsAgentTeamSessionArchiveItem,
  QuantSkillsFrequentSkill, QuantSkillsPlainSessionArchiveItem, QuantSkillsSessionArchiveItem,
...
export interface QuantSkillsAgentModelOption {
  ...
  readonly reasoningEfforts: readonly { readonly id: string; readonly label: string }[]
}
