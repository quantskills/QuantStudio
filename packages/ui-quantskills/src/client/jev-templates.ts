...
export const exchanges = { SHF: '上海期货交易所', DCE: '大连商品交易所', CZC: '郑州商品交易所', CFE: '中国金融期货交易所', INE: '上海国际能源交易中心', GFE: '广州期货交易所' } as const
...
export function withSymbol(config: ContestWatchConfig, symbol: string): ContestWatchConfig {
