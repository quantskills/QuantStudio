...
export const DEFAULT_QUANTSKILLS_COLOR_SCHEME = 'dark' as const

/** Background used with the light palette until the user selects another. */
export const DEFAULT_QUANTSKILLS_LIGHT_BACKGROUND = 'launch' as const

/** Background used with the dark palette until the user selects another. */
export const DEFAULT_QUANTSKILLS_DARK_BACKGROUND = 'motion-minimal-blue' as const
...
export const DEFAULT_QUANTSKILLS_AGENT_PERMISSION = 'workspace-write' as const
...
export const QuantSkillsSettingsSchema: z<QuantSkillsSettings> = z.object({
