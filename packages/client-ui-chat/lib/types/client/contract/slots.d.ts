...
import type { ConversationTurnDataMap, MessageImageLoader, MessageImagesOwnerProps, RenderMessageImages, TurnLocation } from '@deepseek-ai/dsh-client-ui-conversation/client';
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore, SlotHookFactory, SnapshotSelectorHook } from '@deepseek-ai/dsh-client-ui-slots';
...
export interface TurnTailOwnerProps {
    /** Session whose closing Turn owns this tail. */
    sessionId: SessionId;
    turn: TurnLocation;
    seq: number;
...
/** Presentation props supplied to a replaceable conversation label. */
export interface ConversationLabelOwnerProps {
    /** Native label used when an occupant does not change the surrounding experience. */
    defaultLabel: string;
}
...
export type ChatViewSlotProps = PropsRuntime<'conversation.view'> & PropsRenderSlots<'conversation.chat.node' | 'conversation.chat.turnStatus' | 'conversation.message.images'> & PropsStore<ChatStore> & InjectFace<ChatViewInjected> & PropsLocale<'chat'>;
...
import type { FinalDeliverable } from '../chat/final-deliverables.ts';
export interface FinalDeliverablesOwnerProps {
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
    ...
    interface SlotMap {
        'conversation.chat.deliverables': {
            kind: 'single';
            scope: 'session';
            owner: FinalDeliverablesOwnerProps;
        };
        /** Optional presentation override for the live turn-status label. */
        'conversation.chat.turnStatus': {
            kind: 'single';
            scope: 'root';
            owner: ConversationLabelOwnerProps;
        };
        /**
