 ...
 */
export function sameTurnNavigationItem(left, right) {
 ...
 */
export function turnNavigationItem(turn, locations, nodes) {
    const loaded = locations.getTurn(turn)
        .map(key => nodes.get(key))
        .filter((node) => node !== undefined && node.visibility === 'visible');
...
//# sourceMappingURL=turn-navigation.js.map