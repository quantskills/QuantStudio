...
function TurnStatus({ startTime, renderSlot, t }: {
  ...
  /** Authorized renderer for the live turn-status label. */
  ...
  return (
    <div className={css.turnStatus} role="status" aria-live="polite">
      {renderSlot('conversation.chat.turnStatus', { defaultLabel: t('chat.deepDiving') }, {
    ...
    <div className={css.root}>
      <div ref={listRef} className={css.scroll}>
        ...
        <div ref={columnRef} className={css.column} data-chat-flow="">
          ...
          {running && <TurnStatus startTime={runningTurnStart} renderSlot={renderSlot} t={t} />}
