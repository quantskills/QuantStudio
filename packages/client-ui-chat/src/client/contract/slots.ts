...
export type ChatViewSlotProps =
  ...
  & PropsRenderSlots<'conversation.chat.node' | 'conversation.chat.turnStatus' | 'conversation.message.images'>
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  ...
  interface SlotMap {
    'conversation.chat.deliverables': { kind: 'single'; scope: 'session'; owner: FinalDeliverablesOwnerProps }
    /** Optional presentation override for the live turn-status label. */
    'conversation.chat.turnStatus': { kind: 'single'; scope: 'root'; owner: ConversationLabelOwnerProps }
    /**
