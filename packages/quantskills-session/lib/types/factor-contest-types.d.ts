...
export declare const FACTOR_CONTEST_ID = "pandaai-fourth-factor";
...
export type FactorPoolAction = {
    readonly kind: 'create-pool';
    readonly name: string;
    readonly style: string;
    readonly cycle: number;
} | {
    readonly kind: 'update-pool';
    readonly name: string;
    readonly style: string;
    readonly cycle?: number;
} | {
    readonly kind: 'add-factor';
    readonly workflowId: string;
} | {
    readonly kind: 'replace-factor';
    readonly factorId: string;
    readonly workflowId: string;
} | {
    readonly kind: 'remove-factor';
    readonly factorId: string;
} | {
    readonly kind: 'submit-pool';
};
export type FactorPlanAction = FactorPoolAction | {
    readonly kind: 'budget';
    readonly batch: FactorBatchRequest;
};
...
//# sourceMappingURL=factor-contest-types.d.ts.map