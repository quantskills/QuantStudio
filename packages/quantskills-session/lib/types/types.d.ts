...
export type QuantSkillsAuthoringCommitResult = {
    ...
    readonly team: QuantSkillsAgentTeamDefinition;
};
...
export type QuantSkillsAgentTeamModelChoice = {
    ...
    readonly kind: 'fixed';
    readonly selection: QuantSkillsAgentModelSelection;
};
...
export type QuantSkillsFileParsing = {
    readonly status: 'ready';
    readonly kind: 'utf8-text';
} | {
    readonly status: 'ready';
    readonly kind: 'pdf' | 'office-document' | 'spreadsheet';
} | {
