...
export interface ModelServiceVariant { id: string; name: string; baseURL: string; catalogProvider?: string }
...
export interface ModelServiceDefinition {
  id: string; name: string; api: string; variants: ModelServiceVariant[]; docs: string; discovery: boolean
...
export interface ModelConnection {
  route: string; service: string; name: string; baseURL: string; api: string
  configured: boolean; auto: boolean; modelIds: string[]; modelsJson: string
  reasoning?: string
  state: string; message: string
}
export interface ModelVerification {
  state: 'verified' | 'discovery-unavailable' | 'failed'
  code: string; message: string; modelIds: string[]
