...
import type {
  QuantSkillsEncodedFileAttachment,
  QuantSkillsFileAttachmentLimits,
 ...
 */
export function decodeQuantSkillsFileAttachment(
  input: QuantSkillsEncodedFileAttachment,
  maxBytes: number,
): QuantSkillsSaveFileAttachment {
...
export class QuantSkillsFileStore {
   ...
   */
  async saveFile(input: QuantSkillsSaveFileAttachment): Promise<QuantSkillsFileAttachmentRef> {
   ...
   */
  async readFile(
    ref: QuantSkillsFileAttachmentRef,
    signal?: AbortSignal,
  ): Promise<QuantSkillsStoredFileAttachment> {
...
function digestFromAttachmentId(value: string): string {
