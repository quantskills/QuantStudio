...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    'conversation.hero.identity': { kind: 'single'; scope: 'root'; owner: HeroIdentityOwnerProps }
    /** Agent-preset control staged for a New Session. */
    'conversation.hero.agentPreset': { kind: 'single'; scope: 'root'; owner: HeroAgentPresetOwnerProps }
    /** Compact business-owned controls after the Hero preset selector. */
    'conversation.hero.accessory': { kind: 'list'; scope: 'root'; owner: HeroAccessoryOwnerProps }
