 ...
 */
export function resolveQuantSkillsDisplayName(input) {
 ...
 */
export function extractChineseDeclarationTitle(declaration) {
...
function deriveChineseName(assetId, kind, summaryZh) {
    ...
    if (summary === undefined || !containsHan(summary))
        return undefined;
