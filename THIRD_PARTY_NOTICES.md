<!-- Derived from the DSH third-party notice set and maintained by this extracted plugin repository. -->

# Third-Party Notices

QuantStudio is offered under `GPL-3.0-or-later` or a separate [PandaAI commercial license](COMMERCIAL-LICENSE.md). Portions derived from DeepSeek Harness remain licensed under MIT; the preserved license and DeepSeek copyright notice are provided in [LICENSES/DeepSeek-Harness-MIT.txt](LICENSES/DeepSeek-Harness-MIT.txt). The project also depends on the third-party software listed below. Each project remains under its own license; nothing in this file changes those terms.

The dependency notices below are retained from the integrated DSH baseline. Some entries describe the full upstream runtime rather than packages directly present in this application repository. The exact installed application dependency graph is recorded in pnpm-lock.yaml. References to upstream vendor or Python source trees belong to the upstream DSH project.
...
| [`@napi-rs/keyring`](https://github.com/Brooooooklyn/keyring-node) | MIT |
...
| [`@phosphor-icons/react`](https://github.com/phosphor-icons/react) | MIT |
...
| [`dsh-file-upload`](https://github.com/GLFzr/dsh-file-upload/tree/baa569938c03404b4eac6c6740c27afb49b60ba8) | MIT |
...
| [`mustache`](https://github.com/janl/mustache.js) | MIT |
| [`node-addon-require-builtin`](https://www.npmjs.com/package/node-addon-require-builtin) | MIT |
| [`node-pty`](https://github.com/microsoft/node-pty) | MIT |
| [`officeparser`](https://github.com/harshankur/officeParser) | MIT |
| [`open`](https://github.com/sindresorhus/open) | MIT |
| [`pdfjs-dist`](https://github.com/mozilla/pdf.js) | Apache-2.0; Copyright 2024 Mozilla Foundation; bundled with the UI, see `packages/ui-quantskills/LICENSE-PDFJS.txt` |
...
| [`@types/mustache`](https://github.com/DefinitelyTyped/DefinitelyTyped) | MIT |
